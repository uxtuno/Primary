...
{
    private static readonly string filePath = "Assets/Resources/StageData/StageData.xls";
        ...
        foreach (string asset in importedAssets)
        {
            ...
            using (FileStream stream = File.Open (filePath, FileMode.Open, FileAccess.Read))
            {
                ...
                foreach (string sheetName in sheetNames)
                {
                    ...
                    var data = (Entity_StageData)AssetDatabase.LoadAssetAtPath(exportPath, typeof(Entity_StageData));
                    if (data == null)
                    {
                    ...
                    for (int i=1; i<= sheet.LastRowNum; i++)
                    {
                        ...
                        var p = new Entity_StageData.Param();
