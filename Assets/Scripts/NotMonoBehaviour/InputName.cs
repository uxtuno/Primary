public class InputName
{
	...
	/// <para>16. "Submit"</para>
	/// <para>17. "Cancel"</para>
	/// <para>18. "CursorUp"</para>
	/// <para>19. "CursorDown"</para>
	/// <para>20. "CursorLeft"</para>
	/// <para>21. "CursorRight"</para>
	/// <para>22. "Select"</para>
	/// <para>23. "Dash"</para>
	/// </summary>
	public static readonly string[] names = new string[]{"Horizontal","Vertical","Fire1","Fire2","Fire3","Jump","Mouse X","Mouse Y","Mouse ScrollWheel","Horizontal","Vertical","Fire1","Fire2","Fire3","Jump","Submit","Submit","Cancel","CursorUp","CursorDown","CursorLeft","CursorRight","Select","Dash"};
}
